...
def start_bot(bot_token: str, promote_lost_users: bool, lost_user_title: str = None):
    ...
    application.add_handler(CommandHandler("jakauma", commands.distribution_days_command))
    application.add_handler(CommandHandler("jakauma2", commands.distribution_hours_command))
